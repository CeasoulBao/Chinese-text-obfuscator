...
describe('App text workflow', () => {
  ...
  it('configures image overlays and enables export after input', () => {
    ...
    const verticalOpacity = screen.getByLabelText('竖线透明度')
    expect(verticalOpacity).toHaveValue('0.45')
    fireEvent.change(verticalOpacity, { target: { value: '0.7' } })
    expect(verticalOpacity).toHaveValue('0.7')
